...
const config = { ...defaultConfig, timeOffset: '+0100' };

describe('The strings parser function', () => {
  it('should return a string', () => {
    const result = dateStringsToTime('20-04-2020', '13H25', config);
  ...
  it('should return the correct values', () => {
    const result = dateStringsToTime('20-04-2020', '00H25', config);
